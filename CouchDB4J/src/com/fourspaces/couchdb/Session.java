...
public class Session {
    ...
    public CouchResponse loginSession( String userName, String password, Charset charset ) throws IOException {
        ...
        String formattedParameters = URLEncodedUtils.format(
                parameters,
                charset != null ? charset : HTTP.DEF_CONTENT_CHARSET
        );

        String url = buildUrl( "_session" );
        resp = post( "_session", URLEncodedUtils.CONTENT_TYPE, formattedParameters, null );

        System.out.println( "got \"" + resp + "\" for login request" );
